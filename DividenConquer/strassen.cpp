...
m multiply(m m1, m m2)
{
    ...
    P1 = multiply(A, minus1(F, H));
    P2 = multiply(plus1(A, B), H);
    P3 = multiply(plus1(C, D), E);
    P4 = multiply(D, minus1(G, E));
    P5 = multiply(plus1(A, D), plus1(E, H));
    P6 = multiply(minus1(B, D), plus1(G, H));
    P7 = multiply(minus1(A, C), plus1(E, F));

    Q1 = plus1(minus1(plus1(P5, P4), P2), P6);
    Q2 = plus1(P1, P2);
    Q3 = plus1(P3, P4);
    Q4 = minus1(minus1(plus1(P1, P5), P3), P7);
